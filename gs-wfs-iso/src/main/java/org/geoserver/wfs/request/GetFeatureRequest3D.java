 ...
 */
public abstract class GetFeatureRequest3D extends RequestObject {

    public static GetFeatureRequest3D adapt(Object request) {
    ...
    protected GetFeatureRequest3D(EObject adaptee) {
        super(adaptee);
    }
    ...
    public static class WFS11 extends GetFeatureRequest3D {
    ...
    public static class WFS20 extends GetFeatureRequest3D {
