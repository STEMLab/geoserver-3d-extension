 ...
 */
public abstract class Insert3D extends TransactionElement {

    protected Insert3D(EObject adaptee) {
        super(adaptee);
    }
    ...
    public static class WFS11 extends Insert3D {
        ...
        public static InsertElementType unadapt(Insert3D insert) {
    ...
    public static class WFS20 extends Insert3D {
