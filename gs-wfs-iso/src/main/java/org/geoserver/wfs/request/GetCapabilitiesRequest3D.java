 ...
 */
public abstract class GetCapabilitiesRequest3D extends GetCapabilitiesRequest {

    public static GetCapabilitiesRequest3D adapt(Object request) {
    ...
    protected GetCapabilitiesRequest3D(EObject adaptee) {
        super(adaptee);
    }
    ...
    public static class WFS11 extends GetCapabilitiesRequest3D {
    ...
    public static class WFS20 extends GetCapabilitiesRequest3D {
