 ...
 * </p>
 */
public class ISOTransactionEvent {
    private TransactionEventType type;
    private SimpleFeatureCollection affectedFeatures;
    private QName layerName;
    private Object source;
    private final TransactionRequest3D request;

    public ISOTransactionEvent(TransactionEventType type, TransactionRequest3D request, QName layerName,
    ...
    public TransactionType getRequest() {
        return TransactionRequest3D.WFS11.unadapt(request);
    }
