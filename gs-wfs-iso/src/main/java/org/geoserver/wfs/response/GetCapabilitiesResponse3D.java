...
public class GetCapabilitiesResponse3D extends Response {
    public GetCapabilitiesResponse3D() {
    ...
    public boolean canHandle(Operation operation) {
        ...
        return "GetCapabilities".equalsIgnoreCase(operation.getId()) && 
                operation.getService().getId().equals("wfs-3d");
    }

    public String getMimeType(Object value, Operation operation) {
        GetCapabilitiesRequest3D request = GetCapabilitiesRequest3D.adapt(operation.getParameters()[0]);
