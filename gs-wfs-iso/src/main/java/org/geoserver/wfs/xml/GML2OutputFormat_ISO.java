...
import org.geotools.gml.producer.iso.FeatureTransformer;
import org.geotools.gml.producer.iso.FeatureTransformer.FeatureTypeNamespaces;
 ...
 * @version $Id$
 */
public class GML2OutputFormat_ISO extends WFSGetFeatureOutputFormat {
    ...
    */
    ...
    public void prepare(String outputFormat, FeatureCollectionResponse results, GetFeatureRequest3D request)
        throws IOException {
     ...
     */
    public void encode(OutputStream output, FeatureCollectionResponse results, GetFeatureRequest3D request)
