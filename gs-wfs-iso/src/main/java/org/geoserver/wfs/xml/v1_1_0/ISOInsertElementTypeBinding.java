 ...
 * @generated
 */
public class ISOInsertElementTypeBinding extends AbstractComplexEMFBinding {
    WfsFactory wfsfactory;

    public ISOInsertElementTypeBinding(WfsFactory wfsfactory) {
    ...
    public Object parse(ElementInstance instance, Node node, Object value)
        ...
        if (node.hasChild(FeatureCollection.class)) {
            ...
            insertElement.getFeature().addAll(ISODataUtilities.list(fc));
