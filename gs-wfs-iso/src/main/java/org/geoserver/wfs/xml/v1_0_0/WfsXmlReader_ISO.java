...
public class WfsXmlReader_ISO extends XmlRequestReader {
    ...
    public WfsXmlReader_ISO(String element, Configuration configuration, GeoServer geoServer) {
        this(element, configuration, geoServer, "wfs3d");
    }
    
    protected WfsXmlReader_ISO(String element, Configuration configuration, GeoServer geoServer, String serviceId) {
