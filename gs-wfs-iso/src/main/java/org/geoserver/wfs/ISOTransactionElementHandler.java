 ...
 *
 */
public interface ISOTransactionElementHandler {
    /**
    ...
    void execute(TransactionElement element, TransactionRequest3D request, Map<QName, FeatureStore> featureStores, 
