 ...
 * @version $Id$
 */
public class DescribeFeatureType3D {
    /**
    * Catalog reference
    */
    ...
    private static Logger LOGGER = Logging.getLogger(DescribeFeatureType3D.class);
    ...
    /**
         ...
         */
    public DescribeFeatureType3D(WFSInfo wfs, Catalog catalog) {
