...
public class ISOJoinExtractingVisitor extends FilterVisitorSupport {
    ...
    public ISOJoinExtractingVisitor(List<FeatureTypeInfo> featureTypes, List<String> aliases) {
    ...
    boolean isJoinFilter(Expression... expressions) {
        ...
        for (Expression ex : expressions) {
            ISOFilterAttributeExtractor fae = new ISOFilterAttributeExtractor();
            ex.accept(fae, null);
    ...
    private boolean isJoinFilter(Filter filter, Object extraData) {
        ISOJoinExtractingVisitor visitor = new ISOJoinExtractingVisitor(featureTypes, aliases);
    ...
    private Set<String> getFilterPrefixes(Filter filter) {
        ISOFilterAttributeExtractor extractor = new ISOFilterAttributeExtractor();
     ...
     *
     */
    class PropertyNameRewriter extends ISODuplicatingFilterVisitor {
