 ...
 *
 */
public abstract class WFSDescribeFeatureTypeOutputFormat_ISO extends WFSResponse implements SOAPAwareResponse {
    /**
     * Constructor which sets the outputFormat.
     *
     * @param outputFormat The well-known name of the format, not <code>null</code>
     */
    public WFSDescribeFeatureTypeOutputFormat_ISO(GeoServer gs, String outputFormat) {
     ...
     * @param outputFormat The well-known name of the format, not <code>null</code>
     */
    public WFSDescribeFeatureTypeOutputFormat_ISO(GeoServer gs, Set<String> outputFormats) {
