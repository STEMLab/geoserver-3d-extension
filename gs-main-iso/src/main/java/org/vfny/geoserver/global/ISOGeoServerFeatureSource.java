 ...
 * @version $Id$
 */
public class ISOGeoServerFeatureSource implements SimpleFeatureSource {
     ...
     */
    ISOGeoServerFeatureSource(FeatureSource<SimpleFeatureType, SimpleFeature> source, SimpleFeatureType schema, Filter definitionQuery,
     ...
     *
     */
    public static ISOGeoServerFeatureSource create(FeatureSource <SimpleFeatureType, SimpleFeature> featureSource, SimpleFeatureType schema,
    ...
    public static ISOGeoServerFeatureSource create(FeatureSource <SimpleFeatureType, SimpleFeature> featureSource, Settings settings) {
        ...
        return new ISOGeoServerFeatureSource(featureSource, settings);
    }
