...
/**
 * Renaming wrapper for a {@link FeatureLocking} instance, to be used along with {@link ISORetypingDataStore} 
 */
class ISORetypingFeatureLocking extends ISORetypingFeatureStore implements
        SimpleFeatureLocking {

    ISORetypingFeatureLocking(ISORetypingDataStore ds,
            SimpleFeatureLocking wrapped, FeatureTypeMap typeMap) {
        super(ds, wrapped, typeMap);
    }
    
    ISORetypingFeatureLocking(SimpleFeatureLocking wrapped, FeatureTypeMap typeMap) throws IOException {
