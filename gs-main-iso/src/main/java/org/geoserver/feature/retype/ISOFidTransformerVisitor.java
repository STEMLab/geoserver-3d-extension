...
class FidTransformeVisitor extends ISODuplicatingFilterVisitor {
    ...
    public Object visit(Id filter, Object extraData) {
        ...
        for (Iterator it = ids.iterator(); it.hasNext();) {
            ...
            FeatureId retyped = ISORetypingFeatureCollection.reTypeId(id, map.getFeatureType(), map.getOriginalFeatureType());
            fids.add(retyped);
        }
        return ff.id(fids);
    }
