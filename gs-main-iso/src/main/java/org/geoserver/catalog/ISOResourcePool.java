...
public class ISOResourcePool extends ResourcePool {
     ...
     * context.
     */
    public static ISOResourcePool create(Catalog catalog, ApplicationContext appContext) {
        //look for an implementation in spring context
        ISOResourcePool pool = appContext == null ? GeoServerExtensions.bean(ISOResourcePool.class) : 
            GeoServerExtensions.bean(ISOResourcePool.class, appContext);
        if (pool == null) {
            pool = new ISOResourcePool();
        }
     ...
     */
    public static ISOResourcePool create(Catalog catalog) {
    ...
    private GridCoverageReader getGridCoverageReader(CoverageStoreInfo info, CoverageInfo coverageInfo, String coverageName, Hints hints) 
        ...
        if (coverageName != null) {
            ...
            // to the ISOResourcePool without specifying the coverageName: No way to get the proper coverageInfo in
     ...
     * also be unpacked onto the local machine. ISOResourcePool will watch the style
     ...
     * system resources).
     * 
     * @see ISOResourcePool#dataStoreCache
     */
