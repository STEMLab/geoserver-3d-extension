 ...
 */
public class ISODefaultCatalogFacade extends AbstractCatalogFacade implements CatalogFacade {
     ...
     * the catalog
     */
    private ISOCatalogImpl catalog;
    
    public ISODefaultCatalogFacade(Catalog catalog) {
        setCatalog(catalog);
    }
    
    public void setCatalog(Catalog catalog) {
        this.catalog = (ISOCatalogImpl) catalog;
    }
    ...
    public void syncTo(CatalogFacade dao) {
        if (dao instanceof ISODefaultCatalogFacade) {
            //do an optimized sync
            ISODefaultCatalogFacade other = (ISODefaultCatalogFacade) dao;
