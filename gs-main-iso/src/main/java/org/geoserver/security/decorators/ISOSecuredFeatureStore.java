 ...
 * @param <F>
 */
public class ISOSecuredFeatureStore<T extends FeatureType, F extends Feature> extends
        ISOSecuredFeatureSource<T, F> implements FeatureStore<T, F> {

    Transaction transaction;

    FeatureStore<T, F> storeDelegate;

    public ISOSecuredFeatureStore(FeatureStore delegate, WrapperPolicy policy) {
