...
/**
 * See {@link ISOSecuredFeatureStore} for an explanation of why this class exists
 * 
 ...
 * @param <F>
 */
public class ISOSecuredFeatureLocking<T extends FeatureType, F extends Feature> extends
        ISOSecuredFeatureStore<T, F> implements FeatureLocking<T, F> {

    FeatureLocking lockDelegate;

    protected ISOSecuredFeatureLocking(FeatureLocking delegate, WrapperPolicy policy) {
