...
/**
 * The secure version of {@link ISOSecuredFeatureStore}
 * @author Andrea Aime - GeoSolutions
 */
public class ISOSecuredSimpleFeatureStore extends ISOSecuredFeatureStore<SimpleFeatureType, SimpleFeature> implements
        SimpleFeatureStore {

    public ISOSecuredSimpleFeatureStore(SimpleFeatureStore delegate, WrapperPolicy policy) {
