...
class ISOAttributeDescription implements Serializable {
    ...
    static final List<Class<?>> BINDINGS = Arrays.asList(String.class, Boolean.class, Integer.class,
            ...
            Geometry.class, Point.class, Curve.class, Surface.class, Solid.class, MultiPoint.class,
            MultiCurve.class, MultiSurface.class, MultiPrimitive.class);
