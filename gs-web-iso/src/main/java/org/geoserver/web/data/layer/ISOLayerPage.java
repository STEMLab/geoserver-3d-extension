...
public class ISOLayerPage extends GeoServerSecuredPage {
    ...
    public ISOLayerPage() {
        ...
        table = new GeoServerTablePanel<LayerInfo>("table", provider, true) {
            ...
            protected Component getComponentForProperty(String id, IModel<LayerInfo> itemModel,
                ...
                if(property == TYPE) {
                    Fragment f = new Fragment(id, "iconFragment", ISOLayerPage.this);
    ...
    private Component layerLink(String id, final IModel<LayerInfo> model) {
        ...
        return new SimpleBookmarkableLink(id, ISOResourceConfigurationPage.class, new Model<>(linkTitle),
        		ISOResourceConfigurationPage.NAME, layerName, ISOResourceConfigurationPage.WORKSPACE, wsName);
    }
