...
import static org.geoserver.web.data.store.ISOStoreProvider.ENABLED;
import static org.geoserver.web.data.store.ISOStoreProvider.NAME;
import static org.geoserver.web.data.store.ISOStoreProvider.WORKSPACE;
 ...
 * @version $Id$
 * @see StorePage
 * @see ISOStoreProvider
 */
@SuppressWarnings("serial")
public class ISOStorePanel extends GeoServerTablePanel<StoreInfo> {

    private static final long serialVersionUID = 5957961031378924960L;

    private ModalWindow popupWindow;

    public ISOStorePanel(String id, ISOStoreProvider provider, boolean selectable) {
