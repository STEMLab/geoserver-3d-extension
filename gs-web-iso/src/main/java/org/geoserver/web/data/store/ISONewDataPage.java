...
public class ISONewDataPage extends GeoServerSecuredPage {
    ...
    public ISONewDataPage() {
        ...
        final ListView dataStoreLinks = new ListView("vectorResources2", sortedDsNames) {
            @Override
        ...
        final ListView otherStoresLinks = new ListView("otherStores", otherStores) {
            ...
            protected void populateItem(ListItem item) {
                ...
                link.setEnabled(thereAreWorkspaces);
                link.add(new Label("resourcelabel", new ParamResourceModel("other." + store.key, ISONewDataPage.this)));
                item.add(link);
                item.add(new Label("resourceDescription", new ParamResourceModel("other." + store.key + ".description", ISONewDataPage.this)));
