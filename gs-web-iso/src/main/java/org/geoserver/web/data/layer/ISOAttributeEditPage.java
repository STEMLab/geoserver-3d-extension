...
public class ISOAttributeEditPage extends GeoServerSecuredPage {

    ISOAttributeDescription attribute;

    ISONewFeatureTypePage previousPage;
    ...
    public ISOAttributeEditPage(final ISOAttributeDescription attribute,
            final ISONewFeatureTypePage previousPage) {
        this(attribute, previousPage, false);
    }

    ISOAttributeEditPage(final ISOAttributeDescription attribute, final ISONewFeatureTypePage previousPage,
        ...
        final Form<ISOAttributeDescription> form = new Form<>("form", new CompoundPropertyModel<>(attribute));
        form.setOutputMarkupId(true);
        add(form);

        form.add(nameField = new TextField<>("name"));
        DropDownChoice<Class<?>> binding = new DropDownChoice<>("binding", ISOAttributeDescription.BINDINGS,
    ...
    static class BindingChoiceRenderer extends ChoiceRenderer<Class<?>> {
        ...
        public Object getDisplayValue(Class<?> object) {
            return ISOAttributeDescription.getLocalizedName((Class<?>) object);
        }
